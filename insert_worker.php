...
if(empty($fname)||empty($lname)||empty($id)||empty($uname)||empty($doj)||empty($mail)||empty($pas)){
  ...
  $sql = "INSERT INTO workers(user_id, uname, fname, lname, doj, email) VALUES ('$userId', '$uname', '$fname', '$lname', '$doj', '$mail')";
